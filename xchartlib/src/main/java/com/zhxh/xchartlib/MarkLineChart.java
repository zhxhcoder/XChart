...
public class MarkLineChart extends View {
    ...
    public MarkLineChart(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);

        init(new Builder(context), attrs);
    }

    public MarkLineChart(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public MarkLineChart bindData(List<? extends IAxisValue> dataList) {
    ...
    public MarkLineChart bindAnimTime(long animTime) {
        this.animTime = animTime;
        return this;
    }

    public MarkLineChart bindYUnit(String yUnit) {
        this.yUnit = yUnit;
        return this;
    }

    public MarkLineChart bindYFormat(String yFormat) {
